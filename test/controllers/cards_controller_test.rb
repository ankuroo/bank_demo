...
class CardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update card" do
    patch card_url(@card), params: { card: { account_id: @card.account_id, card_no: @card.card_no, cvv: @card.cvv, expiry_date: @card.expiry_date, pin: @card.pin, status: @card.status } }
